...
<div class="col-md-7 col-lg-8">
    <h4 class="mb-3">Введите новые данные</h4>
    <div class="row g-3">
        <?php
        ...
        <div class="col-sm-6">
            ...
            <input class="form-control" value="<?php echo $user_reg['Имя']; ?>">
    ...
    <div style="text-align:center" class="container-fluid py-5">
        <a href="/cabinet"><button class="btn btn-primary btn-lg" type="button">Изменить данные</button></a>
    </div>
